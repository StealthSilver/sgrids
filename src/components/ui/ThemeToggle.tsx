  ...
  return (
    <button
      ...
      className="
        ...
        transition-colors
        bg-white/30 text-black border-black hover:bg-black hover:text-white
        dark:bg-black/30 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black
      "
    >

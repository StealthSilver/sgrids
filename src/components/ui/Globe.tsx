...
export function World(props: WorldProps) {
  ...
  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(40, aspect, 180, 3600)}>
      <WebGLRendererConfig />
      ...
      <OrbitControls
        ...
        autoRotateSpeed={1}
        autoRotate={true}
        minAzimuthAngle={-Math.PI / 2} // 👈 shows only half of globe
        maxAzimuthAngle={Math.PI / 2}  // 👈 limits camera rotation to 180°
